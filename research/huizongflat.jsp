...
<div id="container">
<div id="content">
			<div class="box2" panelTitle="科研绩效分汇总" >
			<form name="form" method="post" action="<%=path+"/JifenhuizongServlet?action=huizong&tongjitype=admin" %>" onSubmit="return checkdata()">
			<input type="hidden" name="url" value="research/huizongflat.jsp" />
			<input type="hidden" name="endtime" value="" />
			<input type="hidden" name="jylx" value="科研" />
			...
			<%
				...
				{
			 %>			
			 <form name="exportform" method="post" action="<%=path+"/JifenhuizongServlet?action=export&exptype=research" %>">
			 <TABLE WIDTH=100% BORDER=0 CELLPADDING=0 CELLSPACING=0>
			 	<tr>
			 	<td>&nbsp;</td>
			 	</tr>
					...
					<thead>
										...
										<%
											...
											<tr class="<%=classStr%>">		
												...
												<td width="1%" align="center"><%=ji.getBenrenname() %>&nbsp;</td>
