												...
												<div class="imrcmain0 imgl imenus_v_main">
													<div class="imcm imde" id="imouter0" class="imouter_v">
														<ul id="imenus0" class="imenus_v">
																			...
																			<li>
																				...
																				<div class="imsc">
																					<div class="imsubc"
																						...
																						<ul style="">
																							<li>
																								<a href="../admin/keyanxmaddflat.jsp" target="frmright">信息录入</a>
																							</li>
																							<li>
																			...
																			<li>
																				...
																				<div class="imsc">
																					<div class="imsubc"
																						...
																						<ul style="">
																							<li>
																								<a href="../admin/lunwenaddflat.jsp" target="frmright">信息录入</a>
																							</li>
																							<li>
																			...
																			<li>
																				...
																				<div class="imsc">
																					<div class="imsubc"
																						...
																						<ul style="">
																							<li>
																								<a href="../admin/zhuangliaddflat.jsp" target="frmright">信息录入</a>
																							</li>
																							<li>
																			...
																			<li>
																				...
																				<div class="imsc">
																					<div class="imsubc"
																						...
																						<ul style="">
																							<li>
																								<a href="../admin/yishuaddflat.jsp" target="frmright">信息录入</a>
																							</li>
																							<li>
																			...
																			<li>
																				...
																				<div class="imsc">
																					<div class="imsubc"
																						...
																						<ul style="">
																							<li>
																								<a href="../admin/keyantdaddflat.jsp" target="frmright">信息录入</a>
																							</li>
																							<li>
															...
															<li class="imatm" style="width: 100%;">
																<a href="../JifenhuizongServlet?action=researchhuizongflat&jylx=科研" target="frmright">
															...
															<li class="imatm" style="width: 100%;">
																...
																<div class="imsc">
																	<div class="imsubc"
																		...
																		<ul style="">
																			<li>
																				<a href="../admin/keyanxmjifenflat.jsp" target="frmright">科研项目</a>
																			</li>
																			<li>
																				<a href="../admin/lunwenjifenflat.jsp" target="frmright">论文、论著、标准和画册</a>
																			</li>
																			<li>
																				<a href="../admin/zhuanglijifenflat.jsp" target="frmright">专利</a>
																			</li>
																			<li>
																				<a href="../admin/yishujifenflat.jsp" target="frmright">艺术作品获奖和收藏</a>
																			</li>
																			<li>
																				<a href="../admin/keyantdjifenflat.jsp" target="frmright">科研团队建设</a>
																			</li>
																		</ul>
																	</div>
																</div>
