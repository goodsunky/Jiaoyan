...
<div id="content">
			...
			<form name="form" method="post" action="<%=path+"/JifenhuizongServlet?action=huizong&tongjitype=department" %>" onSubmit="return checkdata()">
			<input type="hidden" name="url" value="department/huizongflat.jsp" />
			...
			<%
				...
				{
			 %>			
			 <form name="exportform" method="post" action="<%=path+"/JifenhuizongServlet?action=export&exptype=department" %>">
			 <TABLE WIDTH=100% BORDER=0 CELLPADDING=0 CELLSPACING=0>
			 	<tr>
			 	<td>&nbsp;</td>
			 	</tr>
