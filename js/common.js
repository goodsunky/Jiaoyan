...
//全选，取消全选脚本
/*function selectAll(CID,SEL)
{
        //CID：全选按钮的ID;
        //SEL：复选框的Name;
        try{
                        var selectID=document.getElementById(CID);
...
strFrame+='        </td><td width=60 align=center style="font-size:12px;cursor:default;cursor:hand" Author=meizz ';
...
strFrame+='<td width=48 align=center style="font-size:12px;cursor:hand" Author=meizz onmouseover="style.backgroundColor=\'#FFD700\'" ';
...
function meizzToday()  //Today Button
  {
    ...
    meizzTheMonth = new Date().getMonth()+1;
		if(meizzTheMonth/1<10)
			meizzTheMonth=0+meizzTheMonth.toString();
    meizzToDay=new Date().getDate();
		if(meizzToDay/1<10)
			meizzToDay=0+meizzToDay.toString();
    if(outObject){
		outObject.value=meizzTheYear + "-" + meizzTheMonth + "-" + meizzToDay;
    }
    closeLayer();
  }
...
style="BORDER-BOTTOM: #a0a0a0 1px solid; BORDER-LEFT: #a0a0a0 1px solid; BORDER-RIGHT: #a0a0a0 1px solid; BORDER-TOP: #a0a0a0 1px solid"
width="100%">
  <TBODY>
  <TR bgColor=#0080c0>
    <TD align=middle class=ListTitle colSpan=3>梅花雨日历控件2.0新鲜出炉！</TD></TR>
  ...
  <TR bgColor=#ffffff>
    ...
    <TD align=left width="60%"><INPUT onfocus=setday(this)>&nbsp;&nbsp;一般焦点用法
      ...
      <P><INPUT onfocus=setday(this) readOnly>&nbsp;&nbsp;不能输入，只能选择 </P></TD>
    <TD></TD></TR>
  <TR height=20>
    <TD align=middle colSpan=3>&nbsp;</TD></TR>
  <TR bgColor=#d0e4f9 height=20>
