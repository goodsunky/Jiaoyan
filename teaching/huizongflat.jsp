...
<div id="container">
<div id="content">
			<div class="box2" panelTitle="教研绩效分汇总" >
			<form name="form" method="post" action="<%=path+"/JifenhuizongServlet?action=huizong&tongjitype=admin" %>" onSubmit="return checkdata()">
			<input type="hidden" name="url" value="teaching/huizongflat.jsp" />
			<input type="hidden" name="endtime" value="" />
			<input type="hidden" name="jylx" value="教研" />
			...
			<%
				...
				{
			 %>			
			 <form name="exportform" method="post" action="<%=path+"/JifenhuizongServlet?action=export&exptype=teaching" %>">
			 <TABLE WIDTH=100% BORDER=0 CELLPADDING=0 CELLSPACING=0>
			 	<tr>
			 	<td>&nbsp;</td>
			 	</tr>
