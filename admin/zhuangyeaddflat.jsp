...
<div id="container">
<div id="content">
<div class="box2" panelTitle="专业与示范中心信息录入（带*号必填）">
	<TABLE WIDTH=100% BORDER=0 CELLPADDING=0 CELLSPACING=0>
		<tr>
			<td width="5%">
			   	 &nbsp;&nbsp;&nbsp;&nbsp;<a  href="exportfile.jsp?type=ZhuangyeToMysql"  target="_blank" onClick="return hs.htmlExpand(this, { objectType: 'iframe' } )"><img alt="导入数据" border="0" src="../images/import.jpg"></a>       
		    </td>
		    <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;<a href="../upload/moban/zhuangyemoban.xls" target="_blank"><u>模版</u></a></td>
		</tr>
	</table>
	<br>
	<form name="form" method="post" action="../ZhuangyeServlet?action=add" onSubmit="return checkdata()">
	<TABLE WIDTH=100% BORDER=0 CELLPADDING=0 CELLSPACING=0>
		<tr>
		...
		<td width="22%" nowrap="nowrap">
			<div align="left">
				<input name="xmmc" type="text" id="xmmc" size="30">
			</div>		</td>
		<td width="8%" nowrap="nowrap">	  
		...
		<select name="xmlb" onchange="chgjxzf()">
          ...
          <%
			    for (Iterator<Zhuangyejifen_Info> it = zyjfis.iterator(); it.hasNext();)
				{
					...
					{
			    %>
          <option value="<%=zyjfi.getZyjf_khzb() %>" ><%=zyjfi.getZyjf_khzb() %></option>
          		<%}
			    }
			    %>
        </select>		</td>
