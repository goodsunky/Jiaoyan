...
<%@page import="com.jiaoyan.*,com.jiaoyan.zhuoyue.*,com.jiaoyan.necessaryinfo.*,java.util.*,java.text.* " %>
<%
	request.setCharacterEncoding("utf-8");
	Zhuoyue_Info zhyi=(Zhuoyue_Info)request.getAttribute("zhyidetail");
%>
...
<body style="margin:0px;">
	<table   border="1" width="100%" cellspacing="0" cellpadding="0"	bgcolor="#000000">	
	  			<tr bgcolor="#FFFFFF">
	  			   <td ><div align="left">【<%=zhyi.getZhy_zymc() %>】的其他信息&nbsp;</div></td>
	  			</tr>
</table>
	 <table   border="1" width="100%" cellspacing="0" cellpadding="0"	bgcolor="#000000">
	  			<tr align="center">
