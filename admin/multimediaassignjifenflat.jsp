...
<title>多媒体课件积分分配</title>
<link href="../css/style.css" rel="stylesheet" type="text/css"/>	
<link href="../css/btn.css" rel="stylesheet" type="text/css"/>
<script type="text/javascript" src="../js/jquery/jquery.js"></script>
<script type="text/javascript" src="../js/remaincount.js" charset="gb2312"></script>
<script type="text/javascript" src="../js/checkmultimediajifenform.js" charset="gb2312"></script>
...
<div id="container">
<div id="content">
<div class="box2" panelTitle="多媒体课件积分分配" panelWidth="100%">	
	<br>
	<form name="form" method="post" action="../MultimediaServlet?action=doassign&id=<%=id %>" onSubmit="return checkdata(<%=lxmcount %>,<%=jtmcount %>,<%=mmi.getMm_jxzf() %>)">
	...
	<TABLE WIDTH=100% BORDER=0 CELLPADDING=0 CELLSPACING=0>
	    ...
	    <td width="18%" nowrap="nowrap">
		    <div align="left">
		         【本多媒体课件绩效总分】<%=mmi.getMm_jxzf() %>
		   </div>	   
	    </td>
	    <td width="18%" nowrap="nowrap">
		    <div align="left">
		         <input type="button" value="一键分配" class="button2" onClick="javascript:window.location.href='../MultimediaServlet?action=onekeyassign&id=<%=id %>'">
		   </div>	   
	    </td>
	    </tr>
	    </table>
	    ...
	    <br>
	    <%
		   if(mmi.getMm_lxsj()!=null&&!"".equals(mmi.getMm_lxsj()))
		   {
		 %>
		 <fieldset>
	     <legend style="font-weight: bold; ">立项时积分分配信息</legend>
		 <%
		  		if(mmi.getMm_lxmember()!=null&&"".equals(mmi.getMm_lxmember()))
		   		{
		%>
				立项时成员信息为空，无法分配积分！
	    <%
	   ...
	   <br>
	    <%
		   if(mmi.getMm_jtsj()!=null&&!"".equals(mmi.getMm_jtsj()))
		   {
		 %>
		 <fieldset>
	     <legend style="font-weight: bold; ">结题时积分分配信息</legend>
		 <%
		  		if(mmi.getMm_jtmember()!=null&&"".equals(mmi.getMm_jtmember()))
		   		{
		%>
				结题时成员信息为空，无法分配积分！
	    <%
