...
<div id="container">
<div id="content">
<div class="box2" panelTitle="卓越工程师和专业综合信息修改（注：带*号必填，若修改申报人或成员信息，则积分将被清零！）">	
	<br>
	<form name="form" method="post" action="../ZhuoyueServlet?action=doalter&id=<%=id %>" onSubmit="return checkdata()">
	<TABLE WIDTH=100% BORDER=0 CELLPADDING=0 CELLSPACING=0>
		...
		<td width="22%" nowrap="nowrap">
			<div align="left">
				<input name="zymc" type="text" id="zymc" size="40" value="<%=zhyi.getZhy_zymc() %>">
			</div>		</td>
		<td width="8%" nowrap="nowrap">	  
		    <div align="right">负责人*：		    </div>		</td>
		<td width="42%" nowrap="nowrap">
			<div align="left">
			  <input name="fuzeren" type="text" id="fuzeren" size="10" value="<%=zhyi.getZhy_fuzeren() %>">
			</div>		</td>
	</tr>	
	<tr>
...
月</td>
	    ...
	    <td nowrap="nowrap">
         	<input name="zydm" type="text" id="zydm" size="10" value="<%=zhyi.getZhy_zydm() %>">
         </td>
