...
<%
	ArrayList<Zhuoyue_Info> zhyislist=(ArrayList<Zhuoyue_Info>)session.getAttribute("zhyislist");
	Zhuoyue_Info zhysearch=(Zhuoyue_Info)session.getAttribute("zhysearch");	
...
function delSel()
{
	...
	{	
		...
		if(confirm('确定要删除选中的吗？'))
			window.location.href="../ZhuoyueServlet?action=delete&idarray="+msg;
		else
			return false;
...
<div id="container">
<div id="content">
<div class="box2"  panelTitle="卓越工程师和专业综合查询与修改">
<form name="form" method="post" action="../ZhuoyueServlet?action=search&pageNo=1" onSubmit="return checkdata();">
<TABLE WIDTH=100% BORDER=0 CELLPADDING=0 CELLSPACING=0>
	<tr>
	<td width="23%" align="right" nowrap="nowrap">专业名称：</td>
    <td width="19%" nowrap="nowrap"><input name="zymc" type="text" value="<%=zhysearch!=null&&zhysearch.getZhy_zymc()!=null?zhysearch.getZhy_zymc():"" %>"></td>
    <td width="9%" nowrap="nowrap"><div align="right">申报人或成员：</div></td>
    <td width="49%" nowrap="nowrap"><input name="fuzeren" type="text"  value="<%=zhysearch!=null&&zhysearch.getZhy_fuzeren()!=null?zhysearch.getZhy_fuzeren():"" %>"></td>
	</tr> 
	<tr>  
    <td width="23%" nowrap="nowrap"><div align="right">所在部门：</div></td>
    <td width="19%" nowrap="nowrap"><select name="dept">
    ...
    <td><div align="right">档案号：</div></td>
    <td><input type="text" name="danganhao" value="<%=zhysearch!=null&&zhysearch.getZhy_danganhao()!=null?zhysearch.getZhy_danganhao():"" %>"></td>    
    </tr>
    <tr>
    <td width="23%" nowrap="nowrap"><div align="right">立项时间：</div></td>
	...
	年    </td>
		    <td width="9%" nowrap="nowrap"><div id="jtsjtitlediv">
        ...
        <tr>
    <td width="23%" nowrap="nowrap"><div align="right">是否结题：</div></td>
    <td width="19%" nowrap="nowrap">
...
%>
<div>
	<form name="exportform" method="post" action="../ZhuoyueServlet?action=export">
						...
						<td>
							<span class="nobreak"> 当前第<%=pageNo%>页 <span
								class="jive-paginator"> [<a
									href="../ZhuoyueServlet?action=pagesearch&pageNo=<%=pageNo-1 %>">上一页</a> | <%
								for (int i = 1; i <= totalpages; i++) {
							%> <a href="../ZhuoyueServlet?action=pagesearch&pageNo=<%=i %>"> 
							<%
							if(i==pageNo)
							{
							%>
						 ...
						 %> | <a href="../ZhuoyueServlet?action=pagesearch&pageNo=<%=pageNo+1 %>">下一页</a>] </span>
								...
								<div class="jive-table">
									<table summary="List of threads" cellpadding="0" cellspacing="0"  WIDTH=100% >
										...
										<%
												...
												for (Iterator<Zhuoyue_Info> it = zhyislist.iterator(); it.hasNext();)
												 {
											...
											<tr class="<%=classStr%>">
												...
												<td width="1%" nowrap="nowrap">
													<div align="center">
														<%=zhyi.getZhy_zydm() %>&nbsp;													</div>											  </td>
												<td width="1%" >
													<div align="center">
														<%=zhyi.getZhy_fuzeren() %>&nbsp;													</div>												</td>
												<td width="1%" >
													<div align="center">
														<%=zhyi.getZhy_dept_name() %>&nbsp;													</div>												</td>	
												<td width="1%" >
													<div align="center">
													<a href="../ZhuoyueServlet?action=showotherinfo&id=<%=zhyi.getZhy_id() %>" onClick="return hs.htmlExpand(this, { objectType: 'iframe' } )">	
													more...
													</a>													
													</div>												
										      </td>	
										      <td width="1%" >
													<div align="center">														
														<a href="../ZhuoyueServlet?action=delete&idarray=<%=zhyi.getZhy_id() %>" onclick="return confirm('确定要删除吗？')"><img border="0" alt="删除" src="../icons/delete.gif"/></a>
														<a href="../ZhuoyueServlet?action=alter&id=<%=zhyi.getZhy_id() %>"><img border="0" alt="修改" src="../icons/edit.gif"/></a>
														<a href="../ZhuoyueServlet?action=assign&id=<%=zhyi.getZhy_id() %>"><img border="0" alt="积分分配" src="../icons/star.gif"/></a>
													</div>
											  </td>			
