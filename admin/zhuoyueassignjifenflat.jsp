...
<%
	Zhuoyue_Info zhyi=(Zhuoyue_Info)session.getAttribute("zhyidetail");
...
<title>卓越工程师和专业综合积分分配</title>
<link href="../css/style.css" rel="stylesheet" type="text/css"/>	
<link href="../css/btn.css" rel="stylesheet" type="text/css"/>
<script type="text/javascript" src="../js/jquery/jquery.js"></script>
<script type="text/javascript" src="../js/remaincount.js" charset="gb2312"></script>
<script type="text/javascript" src="../js/checkzhuoyuejifenform.js" charset="gb2312"></script>
...
<div id="container">
<div id="content">
<div class="box2" panelTitle="卓越工程师和专业综合积分分配" panelWidth="100%">	
	<br>
	<form name="form" method="post" action="../ZhuoyueServlet?action=doassign&id=<%=id %>" onSubmit="return checkdata(<%=lxmcount %>,<%=jtmcount %>,<%=zhyi.getZhy_jxzf() %>)">
	...
	<TABLE WIDTH=100% BORDER=0 CELLPADDING=0 CELLSPACING=0>
		...
		<td width="18%"  nowrap="nowrap">
			<div align="left">
			【专业名称】<%=zhyi.getZhy_zymc() %>			
			</div>		
		</td>	
		<td width="18%" nowrap="nowrap">
		    <div align="left">
		         【专业代码】<%=zhyi.getZhy_zydm() %>
		   </div>	   
	    </td>
	    <td width="18%" nowrap="nowrap">
		    <div align="left">
		         【本卓越工程师和专业综合绩效总分】<%=zhyi.getZhy_jxzf() %>
		   </div>	   
	    </td>
	    <td width="18%" nowrap="nowrap">
		    <div align="left">
		        <input type="button" value="一键分配" class="button2" onClick="javascript:window.location.href='../ZhuoyueServlet?action=onekeyassign&id=<%=id %>'">
		   </div>	   
	    </td>	
	    </tr>
	    </table>
	   ...
	   %>
	    ...
	    <tr>
		    ...
		    <td width="50%"  nowrap="nowrap">
		    	&nbsp;&nbsp;
				<input name="cancel" type="reset" value="取消"  class="button" onclick="javascript:window.location.href='../ZhuoyueServlet?action=cancel';">			    	    
		    </td>
	    </tr>
	    <tr>
		    <td colspan="2">&nbsp;		    </td>
