...
<div id="container">
<div id="content">
<div class="box2" panelTitle="艺术作品获奖和收藏情况信息录入（带*号必填）">
	<TABLE WIDTH=100% BORDER=0 CELLPADDING=0 CELLSPACING=0>
		<tr>
		  <td width="5%">
			&nbsp;&nbsp;&nbsp;&nbsp;<a  href="exportfile.jsp?type=YishuToMysql"  target="_blank" onClick="return hs.htmlExpand(this, { objectType: 'iframe' } )"><img alt="导入数据" border="0" src="../images/import.jpg"></a>       
	      </td>
	      <td align="left">
	      	&nbsp;&nbsp;&nbsp;&nbsp;<a href="../upload/moban/yishumoban.xls" target="_blank"><u>模版</u></a>
	      </td>
		</tr>
	</table>
	<br>
	<form name="form" method="post" action="../YishuServlet?action=add" onSubmit="return checkdata()">
	<TABLE WIDTH=100% BORDER=0 CELLPADDING=0 CELLSPACING=0>
		<tr>		
	...
	<tr>
		...
		<td width="12%" nowrap="nowrap" align="left">
			<input name="zpmc" type="text" id="zpmc" size="22" >			</td>
		<td width="6%"  nowrap="nowrap">
			<div align="right">获奖名称：</div>		</td>
		<td width="12%" nowrap="nowrap" align="left">
			<input name="hjmc" type="text" id="hjmc" size="22" >			</td>
...
<select name="hjsjmonth">
 <option value="">请选择</option>
  <%
		    ...
		    %>
  <option value="<%=hjsjmon %>" ><%=hjsjmon %></option>
  <%
		    }
		    %>
</select>
月</td>
	   ...
	   <select name="hjdj" onChange="chgjxzf()">
		...
		<td width="12%" nowrap="nowrap" align="left">
			<input name="zbdw" type="text" id="zbdw" size="22" >			</td>
	    <td nowrap="nowrap">		    
