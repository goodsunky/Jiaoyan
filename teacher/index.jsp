													...
													<div class="imcm imde" id="imouter0" class="imouter_v">
														<ul id="imenus0" class="imenus_v">
															...
															<li class="imatm" style="width: 100%;">
																...
																</span><span class="imea imeam_icon11"><span></span>
																</span>个人管理</a>
																...
																<div class="imsc">
																	<div class="imsubc"
																		...
																		<ul style="">
																			<li>
																				<a href="personalinfo.jsp?gh=<%=jiaogonghao %>&dept=<%=dept %>" target="frmright">个人基本信息</a>
																			</li>
																			<li>
																				<a href="../JiaoyanchengjiServlet?action=teacherchengjiflat"" target="frmright">教研与科研成绩</a>
																			</li>
																			<li>
																				<a href="../JifenhuizongServlet?action=teacherhuizongflat" target="frmright">绩效分汇总</a>
																			</li>
																		</ul>
																	</div>
																</div>
